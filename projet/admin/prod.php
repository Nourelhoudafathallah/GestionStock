...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
   ...
   <a href="suppall.php" class="w3-bar-item w3-red w3-button w3-padding">Reset</a>
</nav>
...
while ($row=$result->fetch_assoc())
{
  ...
  <div class='w3-col l3 s6'>
      <div class='w3-container'>
        ...
        <a href='produit2.php?id=".$row["id"]."'><img src='images/".$row["image"]."' style='width:100%'></a>
        <div class='w3-display-middle w3-display-hover'>
            <a href='modif.php?id=".$row["id"]."'><button class='w3-button w3-black'>Modifier</button></a>
          </div>
        </div>
        <center><img src='images/".$row["marque"]."' style='width:60%'></center>
        <a href='produit2.php?id=".$row["id"]."' style='text-decoration:none'><p>".$row["nom"]."<br><b>".$row["prix"]."</b></p></a>
