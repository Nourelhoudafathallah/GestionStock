...
$conn=new mysqli ("localhost","root","","tech");
 echo "<div class='w3-container w3-black w3-padding-32'>
    <h1>Reset</h1>
    <p>Voulez vous vraiment supprimer tout les produit?</p>
    <a href='supprimertout.php'><button type='button' class='w3-button w3-red w3-margin-bottom'>Confirmer</button></a>
     <a href='prod.php'><button type='button' class='w3-button w3-grey w3-margin-bottom'>Annuler</button></a>
  </div>"
  ?>
